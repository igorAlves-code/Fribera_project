            ...
            <div class="main">
                <div id="content" class="content-tab active">
                    <form action="{{route('criarRequisicao')}}" method="post" id="formPecas">
                        ...
                        @if (session('success'))
                            <div class="alert alert-success" role="alert" style="padding: 1rem; width: fit-content; margin-top: 20px; border-radius: 0.5rem; background-color: #d4edda; color: #155724; border: 1px solid #c3e6cb; margin-bottom: 1.5rem; font-weight: bold;">
                                <i class="ri-check-line" style="margin-right: 0.5rem;"></i> {{ session('success') }}
                            </div>
                        @endif
                        @if ($errors->any())
                        <div class="alert alert-warning" role="alert" style="padding: 1rem; width: fit-content; border-radius: 0.5rem; margin-top: 20px; background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; margin-bottom: 1.5rem;">
                            <p style="font-weight: bold; margin-bottom: 0.5rem;">Atenção! Por favor, corrija os seguintes erros:</p>
                        ...
                        <div class="inputs">
                            ...
                            <div class="model-group">
                                ...
                                <input type="text" class="model-input" placeholder="ex.: VB31" name="modelo" required>
                            </div>
                            <div class="model-group">
                                <label for="modeloE" class="model-label">GESP</label>
                                <input type="number" min="0" class="model-input" placeholder="ex.: 12345" name="codigoMaquina" required value="{{ old('codigoMaquina') }}">
                            </div>
                        </div>
                ...
                <div id="consult" class="content-tab">
                    ...
                    <div class="cards">
                        <a href="{{ route('mec') }}" class="cardContent">
                            <div class="topCard">
                        ...
                        <a href="{{ route('mec', ['status' => 'pendente']) }}" class="cardContent">
                            <div class="topCard">
                                <p>Em andamento</p>
                        ...
                        <a href="{{ route('mec', ['status' => 'aprovada']) }}" class="cardContent">
                            <div class="topCard">
                                <p>Concluidas</p>
                        ...
                        <a href="{{ route('mec', ['status' => 'rejeitada']) }}" class="cardContent">
                            <div class="topCard">
                                <p>Rejeitadas</p>
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="{{ $req->id }}">
                                        @php
                                            ...
                                            } elseif ($req->status == 'aprovada') {
                                                $statusClasse = 'status-aprovada';
                                            } elseif ($req->status == 'rejeitada') {
                                                $statusClasse = 'status-rejeitada';
                                            }
                                        @endphp
                                        <td>{{ $req->codigoMaquina }}</td>
                                        <td>{{ $req->modelo }}</td>
                                        <td>{{ $req->data_requisicao }}</td>
                                        <td><p class="{{ $statusClasse }}">{{ $req->status }}</p></td>
                                        <td><a href="{{ route('detalhar', $req->id) }}" class="details">detalhes</a>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
